...
/**
 * Helper class that uses Reflection to create a String representation of an
 * object. The String is pretty-formatted and contains all the properties and
 * their values in the object, its references and superclasses. This is used for
