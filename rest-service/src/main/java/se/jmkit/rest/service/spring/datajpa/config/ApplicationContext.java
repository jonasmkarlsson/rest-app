package se.jmkit.rest.service.spring.datajpa.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = { "se.jmkit.rest.service.spring.datajpa.controller" })
@EnableWebMvc
...
public class ApplicationContext {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() throws ClassNotFoundException {
        ...
        jpaProterties.put(PROPERTY_HIBERNATE_HBM2DDL_IMPORT_FILES, environment.getRequiredProperty(PROPERTY_HIBERNATE_HBM2DDL_IMPORT_FILES));
